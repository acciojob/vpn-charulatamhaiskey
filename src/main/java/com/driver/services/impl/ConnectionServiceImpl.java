...
public class ConnectionServiceImpl implements ConnectionService {
    ...
    public User connect(int userId, String countryName) throws Exception {
        ...
        //get the user by userid from repo
        ...
        if(user.getMaskedIp()!=null)
            ...
            //2. Else if the countryName corresponds to the original country of the user,
            // do nothing. This means that the user wants to connect to its original country,
    ...
    //Else, establish the connection where the maskedIp is "updatedCountryCode.serviceProviderId.userId"
            ...
            List<ServiceProvider> providerslist = user.getServiceProviderList();
